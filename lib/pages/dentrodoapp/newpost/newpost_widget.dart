...
class _NewpostWidgetState extends State<NewpostWidget>
  ...
  void initState() {
    ...
    _model.textFielDescricaoController ??= TextEditingController();
    _model.textFielDescricaoFocusNode ??= FocusNode();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textFieldTituloController,
                                        focusNode:
                                            _model.textFieldTituloFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        ...
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                        validator: _model
                                            .textFieldTituloControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                    Divider(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.textFieldmensagemFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await postRecordReference
                                            ...
                                            postTitle: _model
                                                .textFieldTituloController.text,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .textFielDescricaoController,
                                          focusNode:
                                              _model.textFielDescricaoFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                          ...
                                          minLines: 1,
                                          validator: _model
                                              .textFielDescricaoControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          var groupRecordReference =
                                              GroupRecord.collection.doc();
                                          await groupRecordReference
                                              .set(createGroupRecordData(
                                            groupPhoto: _model.uploadedFileUrl2,
                                            groupName: _model
                                                .textFieldNomeController.text,
                                            groupCreator: currentUserReference,
                                            groupCreatedTime:
                                                getCurrentTimestamp,
                                            groupDescrision: _model
                                                .textFielDescricaoController
                                                .text,
                                          ));
                                          _model.groupRef =
                                              GroupRecord.getDocumentFromData(
                                          ...
                                          _model.member = GruopMebresRecord
                                              .getDocumentFromData(
