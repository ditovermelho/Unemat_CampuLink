...
import 'profile_another_use_follow_model.dart';
export 'profile_another_use_follow_model.dart';

class ProfileAnotherUseFollowWidget extends StatefulWidget {
  const ProfileAnotherUseFollowWidget({
    Key? key,
  ...
  @override
  _ProfileAnotherUseFollowWidgetState createState() =>
      _ProfileAnotherUseFollowWidgetState();
}

class _ProfileAnotherUseFollowWidgetState
    extends State<ProfileAnotherUseFollowWidget> {
  late ProfileAnotherUseFollowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileAnotherUseFollowModel());
